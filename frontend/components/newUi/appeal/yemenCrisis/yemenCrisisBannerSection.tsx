...
const YemanCrisisBannerSection = () => {
  ...
  const oneOffBtnList = [
    { title: "25", doc: "Could provide warm meals to those affected." },
    {
      title: "50",
      doc: "Could provide enough food to feed a family for an entire month or help towards building a home.",
    },
    {
      title: "75",
      doc: "Could provide emergency essentials for communities affected or help towards building a home.",
    },
    {
      title: "300",
      doc: "Could provide emergency shelter for communities affected or help towards building a home.",
    },
    {
      title: "1000",
      doc: "Could provide food for an entire village or help towards building a home.",
    },
    {
      title: "2000",
      doc: "Could provide food, water and medical aid for an entire village or help towards building a home.",
    },
  ];
  const monthBtnList = [
    { title: "25", doc: "Donate £25 a month to help save countless lives" },
  ];
    ...
    <div className="pt-10 lg:pt-20">
      <div className="grid grid-cols-1 gap-8 md:gap-3 lg:gap-8 md:grid-cols-3 px-5 md:px-10">
        ...
        <div className="md:col-span-2">
          <Image
            src={"/donation/yemanCrisis/yemanbanner.jpg"}
            alt=""
            width={700}
            height={700}
