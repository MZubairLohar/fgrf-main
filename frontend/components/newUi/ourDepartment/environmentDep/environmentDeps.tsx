  ...
  return (
    <div className="py-16">
      <div className="flex flex-col items-center max-w-[400px] mx-auto px-3 mb-10">
        <AnimationTop>
          ...
          >
            <div
              id="box3d"
              className="border-4 border-[#85d0d0]  w-60 text-center md:w-[500px] py-1 md:py-3 bg-[#6898b1]  flex justify-center group mx-auto rounded-full shadow-lg"
            >
              <span
                id=""
                className="text-xl md:text-3xl group-hover:text-sky-800 font-bold text-white "
              >
                Our Environment Departments
              </span>
            </div>
          </motion.div>
        </AnimationTop>
      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-4 md:gap-5 lg:gap-8  px-5">
          {EnvironmentDepartmentsList.slice(0, 1).map((appeal, index) => (
            <AnimatedComponentLeft key={index}>
              ...
              >
                <Link
                  href={`environment-department-${appeal.link}`}
          ...
          {/* {EnvironmentDepartmentsList.slice(2, 4).map((appeal, index) => (
          ...
          {EnvironmentDepartmentsList.slice(4, 5).map((appeal, index) => (
            <AnimatedComponentLeft key={index}>
              <div
                key={index}
                className="p-2 w-72 rounded-md bg-[#19afaf] hover:shadow-lg "
...
export default EnvironmentDepartments;
