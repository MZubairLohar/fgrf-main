...
const FedyaKaffaraBannerSec = () => {
    ...
    const fidyaKaffraListDoc = [{ title: "4", doc: "Provide 2 meals for missing 1 fast." },
    { title: "120", doc: "Provide 2 meals a day for 30 days for not being able to fast." }
    ]
    ...
    return (<div className="mt-20 lg:mt-40">
        <div className="grid grid-cols-1 gap-8 md:gap-3 lg:gap-8 md:grid-cols-3 px-5 md:px-10">
            <div className="flex flex-col gap-2">
                <h3 className=" text-2xl md:text-3xl text-gray-800">Fidya or Kaffarah</h3>
            ...
            <div className="md:col-span-2">
                <Image src={"/donation/fidyaKaffarah/fidyaBanner.jpg"} alt="" width={700} height={700} className="lg:h-[560px] w-full" />
            </div>
        </div>
    </div>)
}
