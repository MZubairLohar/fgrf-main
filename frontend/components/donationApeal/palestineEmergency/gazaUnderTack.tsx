...
const GhazaUnderTakDocs = () => {
    return (<div className="py-10 md:py-16 px-5 md:px-10">
        <h2 className="text-teal-500 font-bold text-xl md:text-3xl text-center">GAZA UNDER ATTACK AND UNDER COMPLETE SIEGE!</h2>
        ...
        {/* PennyAppeal */}
        <div>
            <h2 className="text-teal-500 font-bold text-center text-xl md:text-3xl">Penny Appeal is helping people and hospitals in Palestine</h2>
